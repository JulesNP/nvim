        ...
        local function setup()
            ...
            require("gruvbox").setup {
                ...
                overrides = {
                    ...
                    NeoGitDiffAdd = { bg = bg == "dark" and colors.faded_green or colors.bright_green },
                    NeoGitDiffAddHighlight = { bg = colors.neutral_green },
                    NeoGitDiffDelete = { bg = bg == "dark" and colors.faded_red or colors.bright_red },
                    NeoGitDiffDeleteHighlight = { bg = colors.neutral_red },
