    ...
    config = function()
        local function setup()
            ...
            if vim.o.background == "dark" then
                ...
                vim.cmd.highlight "IlluminatedWordRead gui=bold guibg=#3c3836"
                vim.cmd.highlight "IlluminatedWordText gui=bold guibg=#3c3836"
                vim.cmd.highlight "IlluminatedWordWrite gui=bold,underline guibg=#3c3836"
                ...
                vim.cmd.highlight "IlluminatedWordRead gui=bold guibg=#ebdbb2"
                vim.cmd.highlight "IlluminatedWordText gui=bold guibg=#ebdbb2"
                vim.cmd.highlight "IlluminatedWordWrite gui=bold,underline guibg=#ebdbb2"
